...
JNIEXPORT jint JNICALL Java_me_stec_jni_XCrypt_xcry_1open
  ...
  if ( NULL == ( pFdRef = (*env)->GetIntArrayElements(env, pFd, 0) ) ) return XCRY_ERROR;
...
JNIEXPORT jint JNICALL Java_me_stec_jni_XCrypt_xcry_1settwk
  ...
  jbyte *pTweakRef;
  jint res;
  if ( NULL == ( pTweakRef = (*env)->GetByteArrayElements(env, pTweak, 0) ) ) return XCRY_ERROR;
...
JNIEXPORT jint JNICALL Java_me_stec_jni_XCrypt_xcry_1setkey
  ...
  jbyte *pKeyRef;
  jint res;
  if( NULL == ( pKeyRef = (*env)->GetByteArrayElements(env, pKey, 0) ) ) return XCRY_ERROR;
...
JNIEXPORT jint JNICALL Java_me_stec_jni_XCrypt_xcry_1encrypt
  ...
  jint res;
  if( NULL == ( pInBufRef  = (*env)->GetByteArrayElements(env, pInBuf, 0) ) ) return XCRY_ERROR;
  if( NULL == ( pOutBufRef = (*env)->GetByteArrayElements(env, pOutBuf, 0) ) ) { res = XCRY_ERROR; goto end; }
...
JNIEXPORT jint JNICALL Java_me_stec_jni_XCrypt_xcry_1data_1prepare
  ...
  if( NULL == ( pInBufRef  = (*env)->GetByteArrayElements(env, pInBuf, 0) ) ) return XCRY_ERROR;
  if( NULL == ( pOutBufRef = (*env)->GetByteArrayElements(env, pOutBuf, 0) ) ) { res = XCRY_ERROR; goto end_2; }
  if( NULL == ( pSzOutBufRef = (*env)->GetIntArrayElements(env, pSzOutBuf, 0) ) ) { res = XCRY_ERROR; goto end_1; }
//	printf("%s\n", (const u8 *)pInBufRef);
...
JNIEXPORT jint JNICALL Java_me_stec_jni_XCrypt_xcry_1data_1metainfo
  ...
  if( NULL == ( pInDecryptedBlockRef = (*env)->GetByteArrayElements(env, pInDecryptedBlock, 0) ) ) return XCRY_ERROR;
  if( NULL == ( pOutDataTypeRef = (*env)->GetIntArrayElements(env, pOutDataType, 0) ) )         { res = XCRY_ERROR; goto end_2; }
  if( NULL == ( pOutSzDataRef = (*env)->GetIntArrayElements(env, pOutSzData, 0) ) )             { res = XCRY_ERROR; goto end_1; }
  if( NULL == ( pOutNdxDataStartRef = (*env)->GetIntArrayElements(env, pOutNdxDataStart, 0) ) ) { res = XCRY_ERROR; goto end_0; }
